...
@CucumberOptions(
        monochrome = true,
        tags = "@medium-prio",
        features = "src/test/java/com/faisal/tests/cucumber/features/Accounts.feature",
...
public class TestMediumPrioFeatures extends BaseTest {
    private TestNGCucumberRunner testNGCucumberRunner;

    @BeforeClass(alwaysRun = true)
    public void setUpClass() {
        System.out.println("Executing Tests with Medium Priority");
